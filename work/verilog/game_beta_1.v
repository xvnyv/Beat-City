...
module game_beta_1 (
  ...
  wire [1-1:0] M_game_over_clock_detector_out;
  reg [1-1:0] M_game_over_clock_detector_in;
  edge_detector_5 game_over_clock_detector (
    .clk(clk),
    .in(M_game_over_clock_detector_in),
    .out(M_game_over_clock_detector_out)
  );
  ...
  reg [1-1:0] M_game_controlunit_game_over_clock_in;
  ...
  control_unit_9 game_controlunit (
    ...
    .game_over_clock_in(M_game_controlunit_game_over_clock_in),
  ...
  wire [1-1:0] M_game_over_time_value;
  counter_15 game_over_time (
    .clk(clk),
    .rst(rst),
    .value(M_game_over_time_value)
  );
  ...
  always @* begin
    ...
    endcase
    M_game_over_clock_detector_in = M_game_over_time_value;
    M_game_controlunit_game_over_clock_in = M_game_over_clock_detector_out;
